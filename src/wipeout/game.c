...
const game_def_t def = {
	...
	.ai_settings = {
		...
		[RACE_CLASS_RAPIER] = {
			{.thrust_max = 5000, .thrust_magnitude = 60, .fight_back = 1},
			{.thrust_max = 5040, .thrust_magnitude = 61, .fight_back = 1},
			{.thrust_max = 5080, .thrust_magnitude = 62, .fight_back = 1},
			{.thrust_max = 5120, .thrust_magnitude = 63, .fight_back = 1},
			{.thrust_max = 5160, .thrust_magnitude = 64, .fight_back = 1},
			{.thrust_max = 5180, .thrust_magnitude = 65, .fight_back = 1},
			{.thrust_max = 5200, .thrust_magnitude = 65, .fight_back = 1},
		},
	},
