...
const game_def_t def = {
	...
	.ai_settings = {
		...
		[RACE_CLASS_RAPIER] = {
			{.thrust_max = 3800, .thrust_magnitude = 60, .fight_back = 1},
			{.thrust_max = 3820, .thrust_magnitude = 61, .fight_back = 1},
			{.thrust_max = 3850, .thrust_magnitude = 62, .fight_back = 1},
			{.thrust_max = 3880, .thrust_magnitude = 63, .fight_back = 1},
			{.thrust_max = 3920, .thrust_magnitude = 64, .fight_back = 1},
			{.thrust_max = 3950, .thrust_magnitude = 65, .fight_back = 1},
